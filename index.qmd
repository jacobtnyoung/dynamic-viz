...
Or, if you wanted to collection some data? (check out this [network data collection tool](https://jacobtnyoung.shinyapps.io/probation-pilot-app/){target="_blank" rel="noopener"}).
...
Here are some really good FREE books:
  ...
  (https://unleash-shiny.rinterface.com/){target="_blank" rel="noopener"}
  (https://engineering-shiny.org/index.html){target="_blank" rel="noopener"}
